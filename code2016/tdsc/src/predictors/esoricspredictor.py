...
class EsoricsPredictor(Predictor):
    def __init__(self, contributors, f_ratio):
        ...
        self.max_v, self.min_v = self.model.get_max_min_pref()
        #print self.max_v, self.min_v
        return
    ...
    def predict(self, user_id, item_id):
        ...
        pf = min(self.max_v,pf)
        pf = max(self.min_v,pf)

        pt = min(self.max_v,pt)
        pt = max(self.min_v,pt)
        #print self.max_v, self.min_v
