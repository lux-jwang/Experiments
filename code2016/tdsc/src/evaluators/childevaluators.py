...
class JphEvaluator(Evaluator):
    def __init__(self,training_set,testing_set,friends_data=None,friend_num=10):
        self.friends_data = friends_data
    ...
    def build_predictor(self,model):
        ...
        predictor = JphPredictor(ctrbtor, self.friend_num)
        return predictor


class EsoricsSingleUserInfluenceEvaluator(Evaluator):
    def __init__(self,training_set, testing_set, friends_data, f_n, t_n, f_ratio, testfriend=True):
        self.friends_data = friends_data
        self.f_n = f_n
        self.t_n = t_n
        self.f_ratio = f_ratio
    ...
    def evaluate(self):
        ...
        for u_id in test_u_ids:
            ...
            for i_id in test_item_ids:
                ...
                t_idx += 1
                if np.abs(est_prefs1- est_prefs2) >1:
                    s_idx +=1
        ...
        est_preferneces = np.round(est_preferneces,4)
